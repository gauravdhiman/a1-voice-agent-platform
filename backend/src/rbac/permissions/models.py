...
class PermissionBase(BaseModel):
    ...
    action: str = Field(
        ..., min_length=1, max_length=50, description="Action this permission allows"
    )
...
class PermissionUpdate(BaseModel):
    ...
    name: Optional[str] = Field(
        None, min_length=1, max_length=100, description="Permission name"
    )
    description: Optional[str] = Field(
        None, max_length=500, description="Permission description"
    )
    ...
    action: Optional[str] = Field(
        None, min_length=1, max_length=50, description="Action this permission allows"
    )

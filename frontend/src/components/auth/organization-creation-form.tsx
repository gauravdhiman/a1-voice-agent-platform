...
export function OrganizationCreationForm({
  ...
  const handleSkip = async () => {
    ...
    try {
      ...
      const result =
        await organizationService.createSelfOrganization(defaultOrgData);
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Set up your organization with your details, or skip to use default
          settings
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">
            This will be used in your organization&apos;s URL. Use lowercase
        ...
        {onSkip && (
          <div className="mt-4 p-3 bg-gray-50 rounded-md">
            <p className="text-xs text-gray-700 text-center">
              If you skip, we&apos;ll create an organization with default
              settings. You can update these details later in your organization
              page.
            </p>
          </div>
        )}

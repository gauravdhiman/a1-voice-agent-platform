          ...
          {subscription && creditBalance && (
            <div className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-blue-700 dark:text-blue-30">
                      Current Plan:
                    </span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-blue-70 dark:text-blue-300">
                      Status:
                    </span>
                    <Badge
                      variant={
              ...
              <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
                <h4 className="font-semibold text-green-800 dark:text-green-10 mb-3">
                  Credit Information
                </h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-green-70 dark:text-green-300">
                      Total Credits:
                    </span>
                    <span className="font-medium text-green-900 dark:text-green-100">
                      {billingService.formatCredits(
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-green-900 dark:text-green-100">
                      {billingService.formatCredits(
                        creditBalance.subscription_credits,
                      )}
                    </span>
                  </div>
                </div>
              ...
              {subscription.cancel_at_period_end && (
                <div className="bg-orange-50 dark:bg-orange-950 border-orange-20 dark:border-orange-800 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-orange-800 dark:text-orange-10 mb-1">
                        Important Notice
                      </h4>
                      <p className="text-sm text-orange-700 dark:text-orange-200">
                        If you downgraded, changes will apply at the end of the

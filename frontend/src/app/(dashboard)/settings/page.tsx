            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-4">
                  <div
                    className={`border rounded-lg p-3 cursor-pointer transition-all ${theme === 'light'
                  ...
                  <div
                    className={`border rounded-lg p-3 cursor-pointer transition-all ${theme === 'dark'
                        ? 'border-primary bg-primary/5'
                        : 'border-border hover:bg-accent'
                      }`}
                  ...
                  <div
                    className={`border rounded-lg p-3 cursor-pointer transition-all ${theme === 'system'
                        ? 'border-primary bg-primary/5'
                        : 'border-border hover:bg-accent'
                      }`}

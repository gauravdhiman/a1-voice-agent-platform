    ...
    <div className="space-y-8">
      ...
      <Card className="border-dashed border-2 bg-muted/10">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl">Platform Management Under Construction</CardTitle>
          <CardDescription className="max-w-md mx-auto mt-2">
            We are currently building advanced user management features.
            For now, please manage users through their respective organizations.
          </CardDescription>
        </CardHeader>
